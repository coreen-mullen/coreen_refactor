...
#provide list of files or list of ASE atoms objects?
score_multi = grs.get_ensemble_score(['bcc1.data','bcc2.data'])
#under the hood, call coreen's scoring.ensemble_score function
print(score_multi)
#print("!")
exit()
